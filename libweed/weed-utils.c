...
weed_error_t weed_set_float_value(weed_plant_t *plant, const char *key, float value)
{return weed_leaf_set(plant, key, WEED_SEED_FLOAT, 1, (weed_voidptr_t)&value);}
...
{return weed_leaf_set(plant, key, WEED_SEED_STRING, value ? 1 : 0, value ? (weed_voidptr_t)&value : NULL);}

weed_error_t weed_set_funcptr_value(weed_plant_t *plant, const char *key, weed_funcptr_t value)
{return weed_leaf_set(plant, key, WEED_SEED_FUNCPTR, value ? 1 : 0, value ? (weed_voidptr_t)&value : NULL);}

weed_error_t weed_set_voidptr_value(weed_plant_t *plant, const char *key, weed_voidptr_t value)
{return weed_leaf_set(plant, key, WEED_SEED_VOIDPTR, value ? 1 : 0, value ? (weed_voidptr_t)&value : NULL);}

weed_error_t weed_set_plantptr_value(weed_plant_t *plant, const char *key, weed_plant_t *value)
{return weed_leaf_set(plant, key, WEED_SEED_PLANTPTR, value ? 1 : 0, value ? (weed_voidptr_t)&value : NULL);}

weed_error_t weed_set_custom_value(weed_plant_t *plant, const char *key, weed_seed_t seed_type, weed_voidptr_t value)
{return weed_leaf_set(plant, key, seed_type, value ? 1 : 0, value ? (weed_voidptr_t)&value : NULL);}
...
_weed_get_value(float, float, WEED_SEED_FLOAT, 0.);
...
float *weed_get_float_array_counted(weed_plant_t *plant, const char *key, int *count)
{return weed_get_arrayx(plant, key, WEED_SEED_FLOAT, NULL, count);}

float *weed_get_float_array(weed_plant_t *plant, const char *key, weed_error_t *error)
{return weed_get_arrayx(plant, key, WEED_SEED_FLOAT, error, NULL);}
...
{return weed_leaf_set(plant, key, WEED_SEED_UINT, num_elems, (weed_voidptr_t)values);}
...
weed_error_t weed_set_float_array(weed_plant_t *plant, const char *key, weed_size_t num_elems, float *values)
{return weed_leaf_set(plant, key, WEED_SEED_FLOAT, num_elems, (weed_voidptr_t)values);}
...
{return weed_leaf_set(plant, key, WEED_SEED_STRING, values ? num_elems : 1, (weed_voidptr_t)values);}

weed_error_t weed_set_funcptr_array(weed_plant_t *plant, const char *key, weed_size_t num_elems, weed_funcptr_t *values)
{return weed_leaf_set(plant, key, WEED_SEED_FUNCPTR, values ? num_elems : 1, (weed_voidptr_t)values);}

weed_error_t weed_set_voidptr_array(weed_plant_t *plant, const char *key, weed_size_t num_elems, weed_voidptr_t *values)
{return weed_leaf_set(plant, key, WEED_SEED_VOIDPTR, values ? num_elems : 1, (weed_voidptr_t)values);}

weed_error_t weed_set_plantptr_array(weed_plant_t *plant, const char *key, weed_size_t num_elems, weed_plant_t **values)
{return weed_leaf_set(plant, key, WEED_SEED_PLANTPTR, values ? num_elems : 1, (weed_voidptr_t)values);}
...
{return weed_leaf_set(plant, key, seed_type, values ? num_elems : 1, (weed_voidptr_t)values);}
...
weed_error_t weed_leaf_copy_nth(weed_plant_t *dst, const char *keyt, weed_plant_t *src, const char *keyf, int n) {
  ...
  if (!num) err = weed_leaf_set(dst, keyt, seed_type, 0, NULL);
    ...
    case WEED_SEED_FLOAT: _COPY_DATA(float, FLOAT, dst, src, keyt, keyf, n, err); break;
