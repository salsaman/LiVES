...
weed_error_t weed_leaf_copy_nth(weed_plant_t *dst, const char *keyt, weed_plant_t *src, const char *keyf, int n) {
  ...
  if (err == WEED_ERROR_NOSUCH_ELEMENT) {
	...
	// *INDENT-ON*
      ...
      if (datai != NULL)(*_free_func)(datai);
    }
    break;
	...
	// *INDENT-ON*
      ...
      if (datai64 != NULL)(*_free_func)(datai64);
    }
    break;
	...
	// *INDENT-ON*
      ...
      if (datad != NULL)(*_free_func)(datad);
    }
    break;
	...
	// *INDENT-ON*
      ...
      if (dataf != NULL)(*_free_func)(dataf);
    }
    break;
	...
	// *INDENT-ON*
      ...
      if (datav != NULL)(*_free_func)(datav);
    }
    break;
	...
	// *INDENT-ON*
      ...
      if (datap != NULL)(*_free_func)(datap);
    }
    break;
