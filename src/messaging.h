...
#define MSG_ROUTE_STORE				(1 << 5)

#define MSG_ROUTE_BLOCK				(1 << 8)
#define MSG_ROUTE_DEBUG_LOG			(1 << 9)

#define MSG_ROUTE_CACHE				(1 << 16)
...
#define MSGMODE_DEBUG_INIT(pmr)		_DW0(pmr |= (MSG_ROUTE_STDERR | MSG_ROUTE_DEBUG_LOG))
...
#define MSGMODE_DEBUG_LOG(pmr)		_DW0(pmr |= (MSG_ROUTE_STDERR | MSG_ROUTE_LOG))
