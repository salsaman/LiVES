...
#define ATTR_AUDIO_SMPS_PROCESSED			"audio_samps_proc"
...
#define NIRVA_HSDESC_PARALLEL		       	(1ull << 3)
#define NIRVA_HSDESC_SELF_ONLY       		(1ull << 4)
#define NIRVA_HOOK_BEFORE			(1ull << 5)
#define NIRVA_HSDESC_RUN_SINGLE      		(1ull << 16)
#define NIRVA_HSDESC_PERSISTENT	       		(1ull << 17)

NIRVA_TYPEDEF_ENUM(nirva_hook_number,
                   NO_HOOK = -1,
                   // SPONTANEOUS hooks for native threads

                   // transform suffered a FATAL error or was aborted, (NIRVA_HSDESC__NATIVE)
