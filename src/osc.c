...
static const char *get_omc_const(const gchar *cname) {
...
static gboolean setfx (weed_plant_t *plant, weed_plant_t *tparam, int pnum, int nargs, const void *vargs, int skip) {
