...
static LIVES_INLINE G_GNUC_CONST gint pad4(gint val) {
...
static gchar *lives_osc_format_result(weed_plant_t *plant, const gchar *key, int st, int end) {
  int stype;
  int error,i;
  ...
  case WEED_SEED_STRING:
    {
      gchar **vals=weed_get_string_array(plant,key,&error);
      gchar *tmp2;
      for (i=st;i<end;i++) {
...
void lives_osc_cb_play_reverse(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  dirchange_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(TRUE));
...
void lives_osc_cb_play_forward (void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  if (mainw->playing_file==-1&&mainw->current_file>0) {
    ...
    if (cfile->play_paused) freeze_callback(NULL,NULL,0,(GdkModifierType)0,NULL);
    lives_osc_notify_success(NULL);
  }
...
void lives_osc_cb_play_reset (void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  fps_reset_callback(NULL,NULL,0,(GdkModifierType)0,NULL);
  if (cfile->pb_fps<0||(cfile->play_paused&&cfile->freeze_fps<0)) dirchange_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(TRUE));
  if (cfile->play_paused) freeze_callback(NULL,NULL,0,(GdkModifierType)0,NULL);
...
void lives_osc_cb_get_pingpong(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  if (mainw->ping_pong) lives_status_send("1");
...
void lives_osc_cb_fx_reset(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  if (!mainw->osc_block) rte_on_off_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(0));
...
void lives_osc_cb_fgclip_select_next(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  nextclip_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(1));
...
void lives_osc_cb_bgclip_select_next(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  nextclip_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(2));
...
void lives_osc_cb_fgclip_select_previous(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  prevclip_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(1));
...
void lives_osc_cb_bgclip_select_previous(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  prevclip_callback(NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(2));
...
void lives_osc_cb_clip_isvalid(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  if (clip>0&&clip<MAX_FILES&&mainw->files[clip]!=NULL&&!(mainw->multitrack!=NULL&&clip==mainw->multitrack->render_file)&&clip!=mainw->scrap_file) lives_status_send ("1");
  else lives_status_send ("0");
...
static gboolean setfx (gint effect_key, gint pnum, int nargs, const void *vargs) {
  ...
  case WEED_HINT_TEXT:
    {
      gchar **valuess=(gchar **)g_malloc(nargs*sizeof(gchar *));
...
void lives_osc_cb_rte_countparamvals(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  weed_plant_t *inst;
  weed_plant_t **in_params;
  weed_plant_t *tparam;
  weed_plant_t *tparamtmpl;
  ...
  if (hint==WEED_HINT_COLOR) {
    cspace=weed_get_int_value(tparamtmpl,"colorspace",&error);
    if (cspace==WEED_COLORSPACE_RGB) nvals/=3;
    else nvals/=4;
  }
  retval=g_strdup_printf("%d",nvals);
  lives_status_send (retval);
  g_free(retval);
}
...
void lives_osc_cb_rte_getnchannels(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
...
void lives_osc_cb_rte_getparammin(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
...
void lives_osc_cb_rte_getparamdef(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  ...
  if (weed_plant_has_leaf(ptmpl,"host_default")) {
    nvals=weed_leaf_num_elements(ptmpl,"host_default");
    msg=lives_osc_format_result(ptmpl,"host_default",0,nvals);
  }
  else {
...
void lives_osc_cb_rte_getparamval(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
...
void lives_osc_cb_swap(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  if (mainw->multitrack!=NULL) return lives_osc_notify_failure();
  swap_fg_bg_callback (NULL,NULL,0,(GdkModifierType)0,NULL);
  lives_osc_notify_success(NULL);
}
...
void lives_osc_record_start(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  if (mainw->multitrack!=NULL) return lives_osc_notify_failure();
  record_toggle_callback (NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER((gint)TRUE));
  lives_osc_notify_success(NULL);
...
void lives_osc_record_stop(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  if (mainw->multitrack!=NULL) return lives_osc_notify_failure();
  record_toggle_callback (NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER((gint)FALSE));
  lives_osc_notify_success(NULL);
}

void lives_osc_record_toggle(void *context, int arglen, const void *vargs, OSCTimeTag when, NetworkReturnAddressPtr ra) {
  if (mainw->multitrack!=NULL) return lives_osc_notify_failure();
  record_toggle_callback (NULL,NULL,0,(GdkModifierType)0,GINT_TO_POINTER(!mainw->record));
  lives_osc_notify_success(NULL);
}
...
static struct 
{
...
} osc_methods[] = 
  {
    ...
    { "/effect_key/parameter/value/count",		"count",	lives_osc_cb_rte_countparamvals,		        42	},
...
static struct
{
...
} osc_cont[] = 
  {
    ...
    {	"/effect_key/parameter/is_transition/" ,"is_transition", 78, 41,0  },
