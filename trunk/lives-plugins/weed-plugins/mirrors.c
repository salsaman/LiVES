...
weed_plant_t *weed_setup(weed_bootstrap_f weed_boot) {
  ...
  if (plugin_info != NULL) {
    ...
    weed_plant_t *filter_class = weed_filter_class_init("mirrorx", "salsaman", 1, 0, NULL, &mirrorx_process, NULL, in_chantmpls, out_chantmpls,
                                 NULL, NULL);
    ...
    filter_class = weed_filter_class_init("mirrorxy", "salsaman", 1, 0, NULL, &mirrorxy_process, NULL,
